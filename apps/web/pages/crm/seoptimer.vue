<template>
  <div class="mx-auto max-w-6xl px-4 py-8 sm:px-6">
    <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
      <div>
        <h1 class="text-2xl font-semibold text-surface-900">SEOptimer</h1>
    ...
    <nav class="mb-6 flex flex-wrap gap-1 border-b border-surface-200">
      ...
      <NuxtLink to="/crm/seoptimer" class="border-b-2 border-primary-600 px-4 py-3 text-sm font-medium text-primary-600">SEOptimer</NuxtLink>
    </nav>
