    ...
    <template v-else-if="site">
      ...
      <section class="mb-10">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <NuxtLink
            :to="`/sites/${site.id}/bing-webmaster`"
            class="flex items-start gap-3 rounded-xl border border-surface-200 bg-white p-5 shadow-sm transition hover:border-primary-200 hover:shadow-md"
          >
            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-white p-1">
            ...
            <div class="min-w-0">
              <h3 class="font-medium text-surface-900">Bing Webmaster Tools</h3>
              <p class="mt-0.5 text-sm text-surface-500">Bing search and site data</p>
            </div>
          </NuxtLink>
          <NuxtLink
          ...
          >
            ...
            <div class="min-w-0">
              <h3 class="font-medium text-surface-900">WooCommerce</h3>
              <p class="mt-0.5 text-sm text-surface-500">Sales and orders</p>
            </div>
          </NuxtLink>
        </div>
      </section>
      ...
      <section v-if="disconnectedProviders.length > 0" class="mb-10">
        ...
        <p class="mb-6 text-sm text-surface-500">
          Connect data sources for this site. Manage or disconnect from Site settings.
        </p>
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <SiteIntegrationCard
