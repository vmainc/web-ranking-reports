...
/**
 * SEOptimer embed webhook: users paste SEOptimer "API key" on account; POST /api/webhooks/seoptimer verifies `key` and stores rows in seoptimer_leads.
 * Leads are promoted to crm_clients only via in-app "Add to CRM".
 */
migrate((db) => {
